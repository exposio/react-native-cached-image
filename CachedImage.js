...
class CachedImage extends React.Component {
    ...
    static defaultProps = {
        renderImage: props => (<ImageBackground imageStyle={props.style} ref={(ref) => CACHED_IMAGE_REF = ref} {...props} />),
    ...
    listenerSubscribe(remove = false) {
